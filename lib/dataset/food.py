...
class Food(IMDB):
    def __init__(self, image_set, root_path, devkit_path, result_path=None, mask_size=-1, binary_thresh=None):
        ...
        super(Food, self).__init__('food_' + year, image_set, root_path, devkit_path, result_path)  # set self.name
    ...
    def evaluate_detections(self, detections):
        ...
        res_file_folder = os.path.join(self.result_path, 'results', 'Food' + self.year, 'Main')
