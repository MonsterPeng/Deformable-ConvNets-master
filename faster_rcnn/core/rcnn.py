...
def get_rcnn_batch(roidb, cfg):
    ...
    for im_i in range(num_images):
        ...
        im_rois, labels,attri,bbox_targets, bbox_weights = \
            sample_rois(rois, fg_rois_per_image, rois_per_image, num_classes, cfg,
                        labels,attri, overlaps, bbox_targets)
...
def sample_rois(rois, fg_rois_per_image, rois_per_image, num_classes, cfg,
                labels=None, attri=None,overlaps=None, bbox_targets=None, gt_boxes=None):
    """
    ...
    return rois, labels,attri, bbox_targets, bbox_weights
